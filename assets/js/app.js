...
eventOnElements(searchToggler, "click", toggleSearch);
      ...
      fetchData(url.geo(searchField.value), function (locations) {
        ...
        for (const { name, lat, lon, country, state } of locations) {
          ...
          <span class="m-icon">location_on</span>
            ...
            <a aria-label="${name} weather" href="#/weather?lat=${lat}&lon=${lon}" class="item-link has-state" data-search-toggler></a>
          `;
          searchResult
        ...
        eventOnElements(items, "click", function () {
          toggleSearch();
          searchResult.classList.remove("active");
        });
      });
  ...
  fetchData(url.currentWeather(lat, lon), function (currentWeather) {
    ...
    <h2 class="title-2 card-title">Now</h2>
        <div class="weapper">
            ...
            <img class="weather-icon" src="./assets/images/weather_icons/${icon}.png" width="64" height="64" alt="Overcast">
        </div>
    ...
    fetchData(url.reverseGep(lat, lon), function ([{ name, country }]) {
    ...
    <h2 id="highlights-label" class="title-2">Today's Highlights</h2>
    ...
    <div class="highlight-list">
        <div class="card card-sm highlight-card one">
            ...
            <span class="badge aqi-${aqi.aqi} label-${
        aqi.aqi
      }" title="aqi message">
      ...
      for (const [index, data] of forecastList.entries()) {
        ...
        tempLi.innerHTML = `
            <div class="card card-sm slider-card">
                ...
                <img src="./assets/images/weather_icons/${icon}.png" width="48" height="48" loading="lazy" alt="" title="${description}" class="weather-icon">
        ...
        windLi.innerHTML = `
            <div class="card card-sm slider-card">
                ...
                <img src="./assets/images/weather_icons/direction.png" width="48" height="48" loading="lazy" style="transform: rotate(${
                  windDirection - 180
                }deg)" alt="" title="" class="weather-icon">
      ...
      for (let i = 7, len = forecastList.length; i < len; i += 8) {
        ...
        li.innerHTML = `
          <div class="icon-wrapper">
              <img title="${description}" class="weather-icon" src="./assets/images/weather_icons/${icon}.png" width="36" height="36" alt="Overcast Clouds">
              <span class="span">
